...
@smproxy.filter(label="SeedPlacementTool")
@smproperty.input(name="Input")
@smproperty.xml("""
<OutputPort index="0" name='Velocity Field'/>
<OutputPort index="1" name='Seeds' />
  <Hints>
    <View type="None" port="0" />
    <View type="RenderView" port="1" />
    <ShowInMenu category='SeedPlacementTool'/>
  </Hints>
                """)
class SeedPlacementTool(VTKPythonAlgorithmBase):
